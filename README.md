...
**Note: Deploying to netlify using CI!**
You will most likely get an error if you attempt to deploy this app or any on netlify without updating your build settings.
